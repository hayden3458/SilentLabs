      ...
      <div className="w-full max-w-2xl bg-white/10 rounded-3xl shadow-glass p-8 flex flex-col">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          <div>
            ...
            <div className="text-lg font-mono text-white bg-white/20 rounded px-2 py-1 inline-block">{memberDetails.phone}</div>
          </div>
          <div>
            <div className="font-bold text-white/80 mb-1">EMAIL</div>
            <div className="text-lg font-mono text-white bg-white/20 rounded px-2 py-1 inline-block">{member.name.toLowerCase().replace(/ /g, '')}@promptly.com</div>
          </div>
        </div>
        <div className="mb-8">
          <div className="font-bold text-white/80 mb-1">ROLE</div>
          <div className="text-lg text-white bg-white/20 rounded px-2 py-1 inline-block">{memberDetails.role}</div>
        </div>
        <hr className="border-t-2 border-glassgreen-500 my-6" />
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div>
            <div className="font-bold text-white/80 mb-1">DIVISION</div>
            <div className="text-lg text-white bg-white/20 rounded px-2 py-1 inline-block">{memberDetails.division}</div>
          </div>
          <div>
            <div className="font-bold text-white/80 mb-1">DEPARTMENT</div>
            <div className="text-lg text-white bg-white/20 rounded px-2 py-1 inline-block">{memberDetails.department}</div>
          </div>
        </div>
